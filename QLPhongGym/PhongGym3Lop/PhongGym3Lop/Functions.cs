...
namespace PhongGym3Lop
{
    class Functions
    {
        ...
        public static void Connect()
        {
            ...
            Con.ConnectionString = @"Data Source=TRONGDOAN\MSSQLSERVER01;Initial Catalog=PhongGymMoi;Integrated Security=True";
            Con.Open();                  //Mở kết nối
        }
        ...
        public static string ConvertDateTime(string date)
        {
            ...
            return "01/01/2000"; // hoặc báo lỗi
        }
        ...
        public static string CreateKey(string tiento)
        {
            ...
            if (count < 10)
            {
                key = tiento +  "00" + (count + 1);
            }
            else if (count < 100 && count > 10)
            {
                key = tiento + "0" + (count+1);
            }
            else
            {
                key = tiento + "" + (count + 1);
